...
/**
 * Invalidate service worker cache for specific patterns
 */
export function invalidateServiceWorkerCache(pattern: RegExp) {
...
/**
 * Service worker update notification component props
 */
